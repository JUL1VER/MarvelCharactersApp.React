...
Представляет из себя работу с API по получению персонажей и комиксов из Вселенной Marvel. В данном приложении есть страница списка персонажей, где можно посмотреть информацию о конкретном герое, либо ввести в поиске интересующего и посмотреть информацию о нем. Также есть страница со списком комиксов, где так же можно посмотреть информацию о каком-то одном конкретном.
